...
-----------------------------------------------------
    ...
    3. Create a wehbook on the external service your using to trigger webhooks (Github, for instance). You'll need to copy paste the URL generated by Cloud Deploy.
    4. (Optional) Whitelist IP adresses from the webhook service your using. Refer to Providers section for more information about those IPs.
